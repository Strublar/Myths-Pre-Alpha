...
{
    public class EntityCalledMessage : Message
    {
        public int targetId;
        public int x, y;
        public EntityCalledMessage()
        {
            this.messageType = (byte)ServerMessageType.UnitCalled;
        }

        public EntityCalledMessage(int targetId, int x,int y)
        {
            this.messageType = (byte)ServerMessageType.UnitCalled;
