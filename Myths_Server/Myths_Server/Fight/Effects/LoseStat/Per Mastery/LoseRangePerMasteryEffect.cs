...
{
    class LoseRangePerMasteryEffect : Effect
    {
        ...
        #region Constructor
        public LoseRangePerMasteryEffect() : base()
        {
        }

        public LoseRangePerMasteryEffect(TargetSelector sources, TargetSelector targets, List<int> values) 
        ...
        public override void ExecuteOnTarget(int targetId, Context context, FightHandler fightHandler)
        {
            ...
            Effect newEffect = new LoseRangeEffect(
