...
{
    class LoseCallPerMasteryEffect : Effect
    {
        ...
        #region Constructor
        public LoseCallPerMasteryEffect() : base()
        {
        }

        public LoseCallPerMasteryEffect(TargetSelector sources, TargetSelector targets, List<int> values) 
