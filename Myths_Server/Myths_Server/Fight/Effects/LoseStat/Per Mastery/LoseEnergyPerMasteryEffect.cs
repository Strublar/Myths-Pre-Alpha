...
{
    class LoseEnergyPerMasteryEffect : Effect
    {
        ...
        #region Constructor
        public LoseEnergyPerMasteryEffect() : base()
        {
        }

        public LoseEnergyPerMasteryEffect(TargetSelector sources, TargetSelector targets, List<int> values) 
        ...
        public override void ExecuteOnTarget(int targetId, Context context, FightHandler fightHandler)
        {
            ...
            Effect newEffect = new LoseEnergyEffect(
                sources, targets, new List<int> { computedValue, isTemp });
            newEffect.ExecuteOnTarget(targetId, context, fightHandler);

            /*Console.WriteLine( fightHandler.Entities[targetId].Definition.Name+" loses "+computedValue+" energy");
