...
{
    class LoseArmorPerMasteryEffect : Effect
    {
        ...
        #region Constructor
        public LoseArmorPerMasteryEffect() : base()
        {
        }

        public LoseArmorPerMasteryEffect(TargetSelector sources, TargetSelector targets, List<int> values) 
